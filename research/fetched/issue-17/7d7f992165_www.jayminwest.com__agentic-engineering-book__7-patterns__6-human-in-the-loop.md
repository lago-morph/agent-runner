...
Natural gate placement at phase transitions in the [Plan-Build-Review](/agentic-engineering-book/7-patterns/1-plan-build-review) pattern:
...
**See:** [Production Concerns: Lifecycle Hooks](/agentic-engineering-book/8-practices/4-production-concerns) for hook patterns.
...
The [Autonomous Loops (Ralph Wiggum)](/agentic-engineering-book/7-patterns/4-autonomous-loops) pattern deliberately minimizes human intervention—iteration discovers the path. Human-in-the-loop is the complementary pattern for when you need human judgment.
...
## Connections
  ...
  * **To[Plan-Build-Review](/agentic-engineering-book/7-patterns/1-plan-build-review):** Natural gate placement at plan approval. The spec file serves as the approval artifact, enabling review without reading raw code.
  * **To[Autonomous Loops](/agentic-engineering-book/7-patterns/4-autonomous-loops):** Complementary pattern. Ralph Wiggum minimizes gates; human-in-the-loop maximizes oversight. Use both based on risk profile.
  * **To[Production Concerns](/agentic-engineering-book/8-practices/4-production-concerns):** Lifecycle hooks enable gate implementation. PreToolUse hooks can enforce approval before dangerous operations.
  * **To[Orchestrator Pattern](/agentic-engineering-book/7-patterns/3-orchestrator-pattern):** Gates fit naturally at phase transitions. Orchestrators can embed approval logic in phase gating.
  * **To[Self-Improving Experts](/agentic-engineering-book/7-patterns/2-self-improving-experts):** The 4-agent pattern includes HUMAN_IN_LOOP flag for plan agents, enabling per-operation approval control.



[PreviousReAct Pattern](/agentic-engineering-book/7-patterns/5-react-pattern)[NextProgressive Disclosure Pattern](/agentic-engineering-book/7-patterns/7-progressive-disclosure)
