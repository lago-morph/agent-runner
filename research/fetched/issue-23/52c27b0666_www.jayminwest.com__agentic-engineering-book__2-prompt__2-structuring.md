...
## Connections
  ...
  * **[Prompt](/agentic-engineering-book/2-prompt):** Core prompting principles that structure supports
  * **[Prompt Types](/agentic-engineering-book/2-prompt/1-prompt-types):** Different levels of prompt complexity require different structural approaches
  * **[Prompt Language](/agentic-engineering-book/2-prompt/3-language):** Linguistic patterns work in conjunction with structural organization—structure provides the framework, language provides the content
  * **[Context](/agentic-engineering-book/4-context):** How structure helps integrate external context effectively
...
[PreviousPrompt Types](/agentic-engineering-book/2-prompt/1-prompt-types)[NextPrompt Language](/agentic-engineering-book/2-prompt/3-language)
