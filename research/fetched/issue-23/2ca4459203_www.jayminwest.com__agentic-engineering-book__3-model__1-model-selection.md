...
**See Also** :
  ...
  * [Context Loading Demo](/appendices/examples/context-loading-demo/README) — Demonstrates Haiku as retrieval agent with minimal context payloads (~800 tokens)
...
**See Also:**
  ...
  * [Autonomous Loops](/agentic-engineering-book/7-patterns/4-autonomous-loops) — Structural parallel: autoresearch is an autonomous loop applied to model improvement
  * [Cost and Latency](/agentic-engineering-book/8-practices/3-cost-and-latency) — Economics of SLM fine-tuning vs. frontier model API costs
...
**See Also:**
  ...
  * [Agent Frameworks](/agentic-engineering-book/10-practitioner-toolkit/4-agent-frameworks) — Framework comparison and harness capability tiers
  * [Model Evaluation](/agentic-engineering-book/3-model/5-model-evaluation) — Cognitive profiles across providers
  * [Multi-Model Architectures](/agentic-engineering-book/3-model/4-multi-model-architectures) — Cross-provider orchestration patterns
...
## See Also
  ...
  * [Orchestrator Pattern](/agentic-engineering-book/7-patterns/3-orchestrator-pattern) \- How model selection integrates with coordination patterns
  * [Cost and Latency](/agentic-engineering-book/8-practices/3-cost-and-latency) \- Economic optimization for multi-agent systems
...
[PreviousModel](/agentic-engineering-book/3-model)[NextModel Behavior](/agentic-engineering-book/3-model/2-model-behavior)
