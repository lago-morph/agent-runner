...
---|---|---  
[Claude Code](/agentic-engineering-book/1-claude-code) | Coding agent | Anthropic's CLI coding agent with subagent system, Skills, and hooks  
[Google ADK](/agentic-engineering-book/2-google-adk) | Agent framework | Multi-agent-first framework with workflow primitives and state management  
[IDE Integrations](/agentic-engineering-book/3-ide-integrations) | IDE tools | AI coding assistants integrated into development environments  
[Agent Frameworks](/agentic-engineering-book/4-agent-frameworks) | Framework comparison | Comparing LangGraph, CrewAI, AutoGen, and Claude Agent SDK  
[Multi-Agent Workspace Managers](/agentic-engineering-book/5-multi-agent-workspace-managers) | Workspace management | Infrastructure for orchestrating large-scale agent swarms  
[Enterprise Codebase Context Tools](/agentic-engineering-book/6-enterprise-context-tools) | Enterprise context | Tool survey for managing agent context in large brownfield codebases — organized by pattern (as of early 2026)  
  
* * *

## Connections

  * **To[Patterns](/7-patterns):** Tool capabilities shape which patterns are practical. Orchestrator pattern, plan-build-review, and self-improving experts all depend on specific tool features.
  * **To[Context](/4-context):** Different tools implement context management differently—Claude Code's Skills use progressive disclosure, ADK uses persistent state with prefixes.
  * **To[Tool Use](/5-tool-use):** The tools documented here provide concrete implementations of tool use principles—MCP integration, tool restrictions, meta-tools.



[PreviousSoftware Factories](/agentic-engineering-book/9-mental-models/7-software-factories)[NextClaude Code](/agentic-engineering-book/10-practitioner-toolkit/1-claude-code)
