...
Model | Description  
---|---  
[Pit of Success](/agentic-engineering-book/1-pit-of-success) | Design systems where the easiest path is also the correct path  
[Prompt Maturity Model](/agentic-engineering-book/2-prompt-maturity-model) | Seven levels of prompt sophistication from static to meta-cognitive  
[Specs as Source Code](/agentic-engineering-book/3-specs-as-source-code) | Specifications are the primary programming surface in agentic systems  
[Context as Code](/agentic-engineering-book/4-context-as-code) | Treat agent knowledge like software, not documents  
[Execution Topologies](/agentic-engineering-book/5-execution-topologies) | A measurement framework for understanding and improving agent execution structures  
[Design as Bottleneck](/agentic-engineering-book/6-design-as-bottleneck) | When implementation is automated, design becomes the constraint  
[Software Factories](/agentic-engineering-book/7-software-factories) | The resurgence of industrial-scale software production — what the factory metaphor reveals about agentic systems at scale  
  
* * *

## Connections

  * **To[Foundations](/1-foundations):** The four pillars framework (prompts, models, context, tools) is itself a mental model for decomposing agentic systems
  * **To[Patterns](/7-patterns):** Patterns are mental models made concrete through implementation—abstract frameworks translated into specific architectural decisions



[PreviousOperating Agent Swarms](/agentic-engineering-book/8-practices/7-operating-agent-swarms)[NextPit of Success](/agentic-engineering-book/9-mental-models/1-pit-of-success)
