...
## Connections
  ...
  * **To[Context Fundamentals](/agentic-engineering-book/4-context/1-context-fundamentals):** The "One Agent, One Task" principle this technique extends, and Federated knowledge extends "context as payload" to multi-source payloads
  * **To[Advanced Context Patterns](/agentic-engineering-book/4-context/3-context-patterns):** How frequent intentional compaction relates to ACE's growing contexts, and Progressive disclosure pattern enables federated source navigation
  * **To[Multi-Agent Context](/agentic-engineering-book/4-context/4-multi-agent-context):** Orchestrators can stage different federated sources for different subagents
  * **To[Tool Use](/agentic-engineering-book/5-tool-use):** Read tool becomes gateway to federated sources, not just local files
  * **To[Patterns](/agentic-engineering-book/7-patterns):** Emergency Context Rewriting anti-pattern demonstrates why reactive compaction fails
...
## Sources
  ...
  * [BMAD-METHOD Scout Report](/agentic-engineering-book/4-context/.claude/.cache/research/external/bmad-method-scout-report) \- Detailed analysis including federated knowledge section
...
[PreviousContext Fundamentals](/agentic-engineering-book/4-context/1-context-fundamentals)[NextAdvanced Context Patterns](/agentic-engineering-book/4-context/3-context-patterns)
