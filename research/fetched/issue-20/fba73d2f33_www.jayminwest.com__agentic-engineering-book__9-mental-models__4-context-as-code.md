...
**Institutional knowledge preservation:** A security expert's knowledge—how to think about threat models, what to check in audits, which patterns prevent vulnerabilities—becomes **portable code**. When team members change, the expertise remains.
...
**Self-Improving Experts pattern:** Agent-as-code enables the improve phase to update agent definitions directly. Learnings from production update the markdown file, improving future runs.

**Orchestrator pattern:** Manifest-driven transparency shows which agents the orchestrator can coordinate, their capabilities, and dependencies.

**Knowledge Evolution:** Agent definitions are knowledge artifacts that evolve over time, following same version control practices as other context.
...
## Connections
  ...
  * **To[Specs as Source Code](/agentic-engineering-book/9-mental-models/3-specs-as-source-code)**: Agent definitions are specs for agent behavior—same mental model applied to agents
  * **To[Knowledge Evolution](/agentic-engineering-book/8-practices/6-knowledge-evolution)**: Agent definitions evolve through version control like other knowledge artifacts
  * **To[Self-Improving Experts](/agentic-engineering-book/7-patterns/2-self-improving-experts)**: Expertise files are context that agents execute—agent-as-code makes the agent itself executable source
  * **To[Context](/agentic-engineering-book/4-context)**: Agent definitions shape what context enters working memory and how it's interpreted
...
[PreviousSpecs as Source Code](/agentic-engineering-book/9-mental-models/3-specs-as-source-code)[NextExecution Topologies](/agentic-engineering-book/9-mental-models/5-execution-topologies)
