...
**To[Context as Code](/agentic-engineering-book/9-mental-models/4-context-as-code):** Living artifacts are structured knowledge that agents execute—they're source code for behavior.

**To[Plan-Build-Review](/agentic-engineering-book/7-patterns/1-plan-build-review):** Living artifacts provide the research and plan documents that build phase executes from.

**ToAgent-as-Code:** BMAD extends "specs as source code" to agents themselves—agent definitions are markdown + YAML artifacts version-controlled like specifications.
...
## Connections
  ...
  * **To[Context as Code](/agentic-engineering-book/9-mental-models/4-context-as-code)**: Living artifacts are structured context that determines agent behavior
  * **To[Plan-Build-Review](/agentic-engineering-book/7-patterns/1-plan-build-review)**: The plan IS the source code, not scaffolding—BMAD's four-phase methodology demonstrates this at scale
  * **To[Self-Improving Experts](/agentic-engineering-book/7-patterns/2-self-improving-experts)**: Expertise files are specs for agent behavior—same "spec as source code" philosophy
  * **To[Knowledge Evolution](/agentic-engineering-book/8-practices/6-knowledge-evolution)**: Knowledge bases are specs for domain understanding
  * **To[Prompt Structuring](/agentic-engineering-book/2-prompt/2-structuring)**: Structured prompts are executable specifications
...
## Sources
  ...
  * [BMAD Scout Report](/agentic-engineering-book/9-mental-models/.claude/.cache/research/external/bmad-method-scout-report) \- Comprehensive analysis



[PreviousPrompt Maturity Model](/agentic-engineering-book/9-mental-models/2-prompt-maturity-model)[NextContext as Code](/agentic-engineering-book/9-mental-models/4-context-as-code)
